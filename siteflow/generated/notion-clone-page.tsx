...
```bash
npx create-next-app@latest notion-clone --typescript --tailwind
cd notion-clone
```
...
3. **Replace the page content:**
   - Replace `app/page.tsx` with the code above
...
export const metadata: Metadata = {
  title: 'Notion – Your workspace, all-in-one',
  description: 'All-in-one workspace for your docs, wikis, and projects.',
}
...
✅ **Clean Minimal Design** - Black/white with subtle gray accents
✅ **Typography** - Serif headings (Playfair Display) with sans-serif body
✅ **Sticky Navigation** - Always accessible menu
✅ **Hero Section** - Large engaging headline with subtitle
✅ **Feature Cards** - 4 main features with icons and CTAs
✅ **Trusted By** - Social proof section
✅ **Footer** - Comprehensive multi-column layout
✅ **Mobile Menu** - Hamburger menu for mobile devices
✅ **Hover Effects** - Smooth transitions and interactive elements
✅ **Production Ready** - Best practices, accessibility, and performance
