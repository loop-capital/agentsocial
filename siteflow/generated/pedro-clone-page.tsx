...
This Next.js component recreates Pedro Duarte's personal website with the following key features:

**Design Elements:**
- Clean, minimal layout with lots of whitespace
- Large serif heading using `font-serif` class
- Subtle hover animations on navigation and links
- Counter element that increments every 5 seconds (mimicking the "R0/0" brand element)
- Flat design with no shadows or heavy styling

**Typography:**
- Large, readable serif headings
- Good line height and spacing for body text
- Proper text hierarchy with different weights and sizes

**Interactions:**
- Hover effects on navigation links with opacity changes
- Underline animations on inline links
- Subtle lift effect on social media links
- Animated counter in the top right

**Structure:**
- Responsive design that works on mobile and desktop
- Clean semantic HTML structure
- All content from the original site included
- External links open in new tabs with proper security attributes

**Tailwind Classes Used:**
- Typography utilities for font sizes and weights
...
The component is production-ready and follows Next.js best practices with proper imports and TypeScript support.
