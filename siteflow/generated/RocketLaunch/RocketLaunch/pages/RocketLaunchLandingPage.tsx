...
export default function RocketLaunchLandingPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading text-xl font-semibold">RocketLaunch</span>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto">
              RocketLaunch helps teams build faster and smarter.
            </p>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-primary/10 border border-primary/20 p-12 lg:p-20 text-center">
            ...
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">Join thousands of teams already using RocketLaunch.</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-heading font-semibold">RocketLaunch</span>
            </div>
            <p className="text-sm text-muted-foreground">© 2025 RocketLaunch. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
