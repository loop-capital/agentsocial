...
const PLATFORMS = [
  ...
  { id: "linkedin", name: "LinkedIn", color: "#0A66C2", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>, comingSoon: true },
  { id: "tiktok", name: "TikTok", color: "#000000", icon: <Music2 size={18} />, comingSoon: true },
];
          ...
          {activeTab === "social" && (
            <div className="card">
              ...
              <p style={{ color: "#888", fontSize: "0.875rem", marginBottom: "1rem" }}>
                Social account connections are managed per brand. Select a brand in the Brand tab first, then connect your accounts.
              </p>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem", marginBottom: "1.5rem" }}>
                {PLATFORMS.map((platform) => (
                  ...
                  >
                    ...
                    >
                      {platform.comingSoon ? "Connect" : "+ Connect"}
                    </button>
                  </div>
                ))}
              </div>
              ...
              <div className="card" style={{ background: "#161616" }}>
                <h3 style={{ fontSize: "0.95rem", color: "#fff", marginBottom: "0.5rem" }}>Phase 2: OAuth Integration</h3>
                <p style={{ color: "#666", fontSize: "0.85rem", lineHeight: 1.6 }}>
                  Full OAuth flows for Twitter/X, FacebookIcon, InstagramIcon, LinkedIn, and TikTok will be enabled in the next phase.
                  Your connected accounts will appear here once authorized.
                </p>
              </div>
            </div>
          )}
